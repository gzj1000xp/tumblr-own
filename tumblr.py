...
#            print(str(data))
#            print(data["tumblr"]["posts"]["post"].__len__())
            try:
                posts = data["tumblr"]["posts"]["post"]
#                print(posts)
                    #posts = data["tumblr"]["posts"]["post"][start]["photoset"]["photo"]
                for post in posts:
#                    print(post)
                    if "photoset" in post.keys():
                        photosets=post["photoset"]
#                        print(photosets)
#                        print(photosets["photo"])
                        for photoset in photosets["photo"]:
#                            print(photoset)
                            self.queue.put((medium_type, photoset, target_folder))
